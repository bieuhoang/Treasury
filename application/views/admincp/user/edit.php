			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="normal-user">
					<?php echo form_open('admin/user/edit', 'class="form-horizontal" id="normal-user-form"')?>
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="username"
								class="inputTxtForm"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="email"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="first_name"
								value="<?php echo set_value('first_name', isset($user) ? $user->first_name : '') ?>">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="last_name"
								value="<?php echo set_value('last_name', isset($user) ? $user->last_name : '') ?>">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="gender" id="">
									...
									<?php echo (isset($user) and $user->gender == $gender) ? 'selected="selected"' : '' ?>><?php echo $gender ?></option>
									<?php endforeach ?>
								</select>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="company"
								value="<?php echo set_value('company', isset($user) ? $user->company : '') ?>">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="inputTxtForm" name="phone"
								value="<?php echo set_value('phone', isset($user) ? $user->phone : '') ?>">
						</div>
					</div>
				...
				<div
					class="<?php echo  (!(isset($user) and in_array(3, $users_groups))) ? 'tab-pane' : '' ?>"
					id="store-user">
					...
					<?php echo form_open('admin/user/edit', 'class="form-horizontal" id="store-user-form"')?>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="file" name="userfile">
										...
										value="<?php echo $user->avatar ?>"> <img class="avatar"
						...
						<div class="span6">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="inputTxtForm" name="zip"
										value="<?php echo isset($user) ? $user->zip : '' ?>">
								</div>
							</div>
							<div class="control-group">
								<label for="" class="control-label">City</label>
								<div class="controls">
									<input type="text" class="inputTxtForm" name="city"
										value="<?php echo isset($user) ? $user->city : '' ?>">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select name="cat_id" id="">
											...
											<?php echo (isset($user) and $user->cat_id == $cat->id) ? 'selected="selected"' : '' ?>><?php echo $cat->title ?></option>
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="input-append">
										<button class="btn" type="button" id="search-map">Search
											Location!</button>
									</div>
							...
							<input type="hidden" id="longitude" name="longitude"
								value="<?php echo isset($user) ? $user->longitude : '' ?>"> <input
								type="hidden" id="latitude" name="latitude"
								value="<?php echo isset($user) ? $user->latitude : '' ?>">
						</div>
					</div>
				...
				<div
					class="<?php echo (!(isset($user) and in_array(1, $users_groups))) ? 'tab-pane' : '' ?>"
					id="admin-user">
					...
					<div class="control-group">
						<label for="" class="control-label">Password</label>
						<div class="controls">
							<input type="password" class="inputPwForm" name="password"
								value="" id="password-admin-user-form">
						</div>
					</div>
					...
					<div class="control-group">
						<label for="" class="control-label">Retype password</label>
						<div class="controls">
							<input type="password" class="inputPwForm" name="repassword"
								value="">
						</div>
					</div>
