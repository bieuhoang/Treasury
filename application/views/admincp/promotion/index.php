						...
						<tr id="row<?php echo $item->id ?>">
							...
							<td>
								<?php if($item->id != 1): ?>
									...
									<a class="item-action" data-action="block" href="javascript:;" data-id="<?php echo $item->id ?>" title="Block" data-toggle="tooltip"><span class="icon-ok-circle"></span></a> 
									<?php else: ?>
									<a class="item-action" data-action="active" href="javascript:;" data-id="<?php echo $item->id ?>" title="Active" data-toggle="tooltip"><span class="icon-ban-circle"></span></a> 
									<?php endif ?>
								<?php endif ?>
							</td>
						</tr>
